import { HouseAvailability, Note, Profile, ProfileRole, ProfileWorkDay, ProfileWorkSchedule, TaskTypeName, WorkGroup, WorkGroupProfile, WorkGroupTask } from '../../core/models/data.models';
